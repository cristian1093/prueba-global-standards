        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!(typeof _this2.movie.image === 'string')) {
                _context.next = 13;
                break;
              }
              _context.next = 9;
              return _this2.urlToFile(_this2.movie.image);
            case 9:
              file = _context.sent;
              ...
              break;
            case 13:
              if (_this2.movie.image instanceof File) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 5:
              blob = _context2.sent;
              return _context2.abrupt("return", new File([blob], 'image.jpg', {
                type: 'image/jpeg'
              }));
            case 7:
            case "end":
